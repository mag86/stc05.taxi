        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-sm-offset-2 col-md-offset-4">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">  <%=greeting%><%=login%>!</h3>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table-fill">
                        ...
                        <tr>
                            ...
                            <th class="text-left">тел</th><th>имя водителя</th>
                            <th class="text-left">тип авто</th><th>марка авто</th>
                            <th class="text-left">госномер</th><th>цвет</th>
                        </tr>
                        </thead>
